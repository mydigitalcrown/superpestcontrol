...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Worli, Mumbai. Expert termite control, cockroach treatment, bed bug removal near Lower Parel, Prabhadevi, Mahalaxmi, Dadar. 100% guaranteed results. Call ☎️ +91-9136036071 for immediate service.',
