    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            <Link href="/" className="flex items-center space-x-2 md:space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-orange-600 font-medium -mt-1 opacity-70 hidden sm:block">Virar West & East</span>
              </div>
            </Link>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-gray-200 font-light">
              Expert pest management solutions for Virar West, Virar East and surrounding areas
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our Pest Control Services in Virar
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Virar Cockroach Control", description: "Advanced treatments for Virar West & East homes", icon: "🪳", price: "₹1,800+" },
              { title: "Coastal Termite Treatment", description: "Specialized treatment for coastal environment", icon: "🐜", price: "₹3,500+" },
              { title: "Rodent Control", description: "Safe and effective pest control for homes", icon: "🐭", price: "₹2,200+" },
              { title: "Bed Bug Treatment", description: "Complete elimination with warranty", icon: "🛏️", price: "₹2,800+" },
              { title: "Mosquito Control", description: "Breeding control near water bodies", icon: "🦟", price: "₹1,600+" },
              { title: "Complete Pest Control", description: "Full-service treatment for all pests", icon: "🐛", price: "₹3,000+" }
            ].map((service, index) => (
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-2xl font-bold mb-4">Super Pest Control Virar</div>
          <p className="text-gray-400 mb-6">Professional pest control services in Virar West & East, Mumbai</p>
