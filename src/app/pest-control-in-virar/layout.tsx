...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Virar, Mumbai. Expert termite control, cockroach treatment, bed bug removal near Virar East, Virar West, Vasai, Nalasopara. 100% guaranteed results. Call ☎️ +91-9136036071 for immediate service.',
