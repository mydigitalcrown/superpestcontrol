...
export const metadata = {
  ...
  alternates: {
    canonical: "https://superpestcontrol.in/pest-control-pune"
  },
  openGraph: {
    type: "website",
    title: "Best Pest Control Services in Pune | Super Pest Control Mumbai", 
    ...
    url: "https://superpestcontrol.in/pest-control-pune",
    locale: "en_IN",
...
export default function PestControlPune() {
    ...
    "@graph": [
      {
        ...
        "description": "Professional pest management services throughout Pune metropolitan area",
        "url": "https://superpestcontrol.in/pest-control-pune",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": "https://superpestcontrol.in/pest-control-pune"
          }
        ]
      }
    ]
  ...
  return (
    <>
      ...
      <Header subtitle="Pune's Premier Pest Control" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto">
                Professional pest management services throughout Pune metropolitan area - Expert solutions with 5-year warranty and 24/7 emergency service
              </p>
