...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'en-IN': 'https://superpestcontrol.in/pest-control-in-kamothe',
      'hi-IN': 'https://superpestcontrol.in/hi/pest-control-in-kamothe',
      'mr-IN': 'https://superpestcontrol.in/mr/pest-control-in-kamothe'
    }
  },
  openGraph: {
