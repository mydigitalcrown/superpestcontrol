    ...
    "@graph": [
      {
        ...
        "description": "Comprehensive pest control across all Navi Mumbai sectors and nodes",
        "url": "https://superpestcontrol.in/pest-control-in-navi-mumbai",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto">
                Comprehensive pest control across all Navi Mumbai sectors and nodes - Expert solutions with 5-year warranty and 24/7 emergency service
              </p>
