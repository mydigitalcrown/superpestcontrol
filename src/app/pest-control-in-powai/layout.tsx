...
export const metadata: Metadata = {
  title: 'Best Pest Control in Powai | #1 Professional Services Mumbai | Super Pest Control',
  description: 'Professional Pest Control Services in Powai, Mumbai. Expert termite control, cockroach treatment, bed bug removal near Powai Lake, Hiranandani Gardens, IIT Powai, Chandivali. 100% guaranteed results. Call ☎️ +91-8097941077 for immediate service.',
  ...
  openGraph: {
    title: 'Professional Pest Control in Powai | Super Pest Control Services',
