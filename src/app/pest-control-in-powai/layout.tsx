...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Powai, Mumbai. Expert termite control, cockroach treatment, bed bug removal near Powai Lake, Hiranandani Gardens, IIT Powai, Chandivali. 100% guaranteed results. Call ☎️ +91-9136036071 for immediate service.',
