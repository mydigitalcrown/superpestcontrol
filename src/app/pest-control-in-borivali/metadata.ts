...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Borivali, Mumbai. Expert termite control, cockroach treatment, bed bug removal. 100% guaranteed results. Call ☎️ +91-9136036071 for immediate service.',
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://superpestcontrol.in/images/pest-control-borivali-banner.jpg',
        width: 1200,
        height: 630,
        alt: 'Professional Pest Control Services in Borivali'
      }
    ],
    locale: 'en_IN',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Best Pest Control in Borivali | Super Pest Control',
    description: 'Professional pest control services in Borivali with guaranteed results. Call now for expert treatment!',
    images: ['https://superpestcontrol.in/images/pest-control-borivali-twitter.jpg'],
  ...
  alternates: {
    ...
    languages: {
      'en-IN': 'https://superpestcontrol.in/pest-control-in-borivali',
      'hi-IN': 'https://superpestcontrol.in/hi/pest-control-in-borivali',
      'mr-IN': 'https://superpestcontrol.in/mr/pest-control-in-borivali'
    }
  },
  verification: {
  ...
  other: {
    'geo.region': 'IN-MH',
    'geo.placename': 'Borivali, Mumbai',
    'geo.position': '19.2307,72.8568',
    'ICBM': '19.2307, 72.8568',
