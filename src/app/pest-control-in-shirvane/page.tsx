...
export default function PestControlShirvane() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            <Link href="/" className="flex items-center space-x-2 md:space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-orange-600 font-medium -mt-1 opacity-70 hidden sm:block">Shirvane</span>
              </div>
            </Link>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-gray-200 font-light">
              Expert pest management solutions for Shirvane&apos;s residential and agricultural areas
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our Pest Control Services in Shirvane
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Rural Cockroach Control", description: "Eco-safe treatments for village homes", icon: "🪳", price: "₹1,400+" },
              { title: "Agricultural Termite Treatment", description: "Specialized protection for farm properties", icon: "🐜", price: "₹2,600+" },
              { title: "Farm Rodent Management", description: "Safe solutions for agricultural settings", icon: "🐭", price: "₹1,900+" },
              { title: "Home Bed Bug Treatment", description: "Complete elimination for rural households", icon: "🛏️", price: "₹2,100+" },
              { title: "Village Mosquito Control", description: "Natural control methods for farming areas", icon: "🦟", price: "₹1,200+" },
              { title: "Complete Rural Pest Management", description: "Comprehensive village pest solutions", icon: "🐛", price: "₹2,800+" }
            ].map((service, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-pink-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Get Rid of Pests in Shirvane?
          </h2>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-2xl font-bold mb-4">Super Pest Control Shirvane</div>
          <p className="text-gray-400 mb-6">Professional pest control services in Shirvane, Mumbai</p>
