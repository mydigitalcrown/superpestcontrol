    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-red-900 via-red-800 to-red-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Tick Control Services in <span className="text-orange-400">Mumbai</span></h1>
            <p className="text-xl md:text-2xl mb-8 text-red-100">Professional tick removal and prevention. Protect your family and pets from dangerous tick-borne diseases.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-red-900 px-8 py-4 rounded-lg font-semibold text-lg transition-colors">Tick Treatment</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Tick Elimination</h3>
              <p className="text-gray-600">Complete tick removal from your property and surroundings.</p>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Pet Protection</h3>
              <p className="text-gray-600">Safe treatment methods that protect your beloved pets.</p>
            </div>
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Yard Treatment</h3>
              <p className="text-gray-600">Comprehensive outdoor and garden tick control programs.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-red-500 to-red-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Protect Against Disease</h2>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+918097941077" className="bg-white text-red-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors">📞 Call +91 80979-41077</a>
            <a href="tel:+918097941076" className="bg-red-700 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-red-800 transition-colors">📞 Call +91 80979-41076</a>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-4">Professional Tick Control Services</p>
          </div>
        </div>
      </footer>
    </div>
