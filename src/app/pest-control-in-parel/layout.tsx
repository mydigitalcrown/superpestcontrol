...
export const metadata: Metadata = {
  title: 'Pest Control in Parel | 24/7 Service | Super Pest Control',
  description: 'Get fast pest control in Parel. 100% guaranteed results. Call 8097941077 for same-day service!',
