...
export const metadata: Metadata = {
  title: 'Pest Control in Matunga | 24/7 Service | Super Pest Control',
  description: 'Professional Pest Control Services in Matunga, Mumbai. Expert termite control, cockroach treatment, bed bug removal near Matunga East, Matunga West, King Circle, Mahim Junction. 100% guaranteed results. Call ?? +91-8097941077 for immediate service.',
  ...
  openGraph: {
    title: 'Pest Control in Matunga | Super Pest Control Services',
