...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Juinagar, Navi Mumbai. Expert termite control, cockroach treatment, bed bug removal near Nerul, Seawoods, Belapur. 100% guaranteed results. Call ☎️ +91-9136036071 for immediate service.',
