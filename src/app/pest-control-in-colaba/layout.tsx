...
export const metadata: Metadata = {
  title: 'Pest Control in Colaba | 24/7 Service | Super Pest Control',
  description: 'Get fast pest control in Colaba. 100% guaranteed results. Call 8097941077 for same-day service!',
