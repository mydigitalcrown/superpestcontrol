...
const faqData = [
  ...
  },
  {
    ...
    answer: "Pest control in Lokhandwala costs between ₹2,000 to ₹6,500 depending on the type of pest, property size, and treatment required. Super Pest Control offers free inspections, competitive pricing, and transparent costs with no hidden charges for Lokhandwala properties."
  },
  {
...
export default function PestControlLokhandwala() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Header subtitle="Professional Pest Control in Lokhandwala" />
