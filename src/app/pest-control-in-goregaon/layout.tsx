...
export const metadata: Metadata = {
  title: 'Pest Control in Goregaon | 24/7 Service | Super Pest Control',
  description: 'Professional Pest Control Services in Goregaon, Mumbai. Expert termite control, cockroach treatment, bed bug removal near Goregaon Station, Malad, Film City. 100% guaranteed results. Call ?? +91-8097941077 for immediate service.',
  ...
  openGraph: {
    title: 'Pest Control in Goregaon | Super Pest Control Services',
