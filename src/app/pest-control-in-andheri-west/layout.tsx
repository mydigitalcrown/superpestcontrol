...
export const metadata: Metadata = {
  ...
  description: 'Expert pest control services in Andheri West, Mumbai. Professional termite control, cockroach treatment, bed bug removal near Lokhandwala, Juhu, Versova. 100% guaranteed results. Call +91-8097941077.',
