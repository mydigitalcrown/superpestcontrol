...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Viman Nagar, Pune. Expert termite control, cockroach treatment, bed bug removal near Kharadi, Kalyani Nagar, Nagar Road, Airport Road. 100% guaranteed results. Call ☎️ +91-9136036071 for immediate service.',
