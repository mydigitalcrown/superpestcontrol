...
export const metadata: Metadata = {
  ...
  description: 'Professional pest control in Ghatkopar. Termite, cockroach & bed bug removal. 100% guaranteed. Call ☎️ 8097941077 for same-day service.',
  ...
  openGraph: {
    title: 'Pest Control in Ghatkopar | Super Pest Control Services',
