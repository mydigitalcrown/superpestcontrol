...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Mahim, Mumbai. Expert termite control, cockroach treatment, bed bug removal near Mahim Bay, Shivaji Park, Dadar West, King Circle. 100% guaranteed results. Call ☎️ +91-9136036071 for immediate service.',
