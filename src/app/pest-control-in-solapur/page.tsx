...
export default function PestControlSolapur() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            <Link href="/" className="flex items-center space-x-2 md:space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-orange-600 font-medium -mt-1 opacity-70 hidden sm:block">Solapur</span>
              </div>
            </Link>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-gray-200 font-light">
              Expert pest management solutions for Solapur&apos;s textile and commercial areas
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our Pest Control Services in Solapur
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Textile Mill Cockroach Control", description: "Specialized treatments for textile industries", icon: "🪳", price: "₹1,700+" },
              { title: "Commercial Termite Treatment", description: "Advanced protection for business centers", icon: "🐜", price: "₹2,800+" },
              { title: "Factory Rodent Control", description: "Industrial-grade rodent management", icon: "🐭", price: "₹2,200+" },
              { title: "Commercial Bed Bug Treatment", description: "Professional treatment for hotels and lodges", icon: "🛏️", price: "₹2,500+" },
              { title: "Industrial Mosquito Control", description: "Large-scale breeding site management", icon: "🦟", price: "₹1,400+" },
              { title: "Complete Industrial Pest Control", description: "Full-service manufacturing pest solutions", icon: "🐛", price: "₹3,600+" }
            ].map((service, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-pink-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Get Rid of Pests in Solapur?
          </h2>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-2xl font-bold mb-4">Super Pest Control Solapur</div>
          <p className="text-gray-400 mb-6">Professional pest control services in Solapur, Maharashtra</p>
