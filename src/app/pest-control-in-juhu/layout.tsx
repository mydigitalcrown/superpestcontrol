...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'en-IN': 'https://superpestcontrol.in/pest-control-in-juhu',
      'hi-IN': 'https://superpestcontrol.in/hi/pest-control-in-juhu',
      'mr-IN': 'https://superpestcontrol.in/mr/pest-control-in-juhu'
    }
  },
  openGraph: {
