...
export default function PestControlBavdhan() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            <Link href="/" className="flex items-center space-x-2 md:space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-orange-600 font-medium -mt-1 opacity-70 hidden sm:block">Bavdhan</span>
              </div>
            </Link>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-gray-200 font-light">
              Expert pest management solutions for Bavdhan&apos;s residential and IT hub areas
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Premium Cockroach Control", description: "Advanced treatments for upscale neighborhoods", icon: "🪳", price: "₹2,000+" },
              { title: "Corporate Termite Treatment", description: "Professional protection for office complexes", icon: "🐜", price: "₹3,500+" },
              { title: "Tech Hub Rodent Control", description: "Specialized solutions for IT environments", icon: "🐭", price: "₹2,800+" },
              { title: "Luxury Bed Bug Treatment", description: "Premium service for high-end properties", icon: "🛏️", price: "₹3,200+" },
              { title: "Smart Mosquito Control", description: "Modern breeding control technology", icon: "🦟", price: "₹1,800+" },
              { title: "Complete Premium Pest Control", description: "Full-service elite pest management", icon: "🐛", price: "₹4,000+" }
            ].map((service, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-pink-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Get Rid of Pests in Bavdhan?
          </h2>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-2xl font-bold mb-4">Super Pest Control Bavdhan</div>
          <p className="text-gray-400 mb-6">Professional pest control services in Bavdhan, Pune</p>
