...
export const metadata: Metadata = {
  ...
  description: 'Expert pest control services in Alibag. Termite, cockroach, rodent, bed bug control with 10+ years experience. Licensed professionals, 24/7 service. Call +91-9136036071 for free inspection.',
