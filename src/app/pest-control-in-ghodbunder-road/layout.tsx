...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Ghodbunder Road, Thane. Expert termite control, cockroach treatment, bed bug removal near Majiwada, Wagle Estate, Thane West. 100% guaranteed results. Call ☎️ +91-8097941077 for immediate service.',
