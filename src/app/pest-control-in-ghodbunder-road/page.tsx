...
export default function PestControlGhodbunderRoad() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            <Link href="/" className="flex items-center space-x-2 md:space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-orange-600 font-medium -mt-1 opacity-70 hidden sm:block">Ghodbunder Road</span>
              </div>
            </Link>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              Professional Pest Control Services on 
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-gray-200 font-light">
              Expert pest management solutions for Ghodbunder Road&apos;s residential complexes and commercial areas
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our Pest Control Services on Ghodbunder Road
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "High-rise Cockroach Control", description: "Advanced treatments for tower complexes", icon: "🪳", price: "₹2,200+" },
              { title: "Complex Termite Treatment", description: "Comprehensive treatment for residential complexes", icon: "🐜", price: "₹4,000+" },
              { title: "Tower Rodent Control", description: "Safe rodent control for high-rise buildings", icon: "🐭", price: "₹2,500+" },
              { title: "Apartment Bed Bug Treatment", description: "Specialized treatment for residential units", icon: "🛏️", price: "₹3,000+" },
              { title: "Complex Mosquito Control", description: "Breeding control for residential complexes", icon: "🦟", price: "₹1,800+" },
              { title: "Complete Complex Pest Control", description: "Full-service treatment for residential towers", icon: "🐛", price: "₹3,500+" }
            ].map((service, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-pink-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Get Rid of Pests on Ghodbunder Road?
          </h2>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-2xl font-bold mb-4">Super Pest Control Ghodbunder Road</div>
          <p className="text-gray-400 mb-6">Professional pest control services on Ghodbunder Road, Thane</p>
