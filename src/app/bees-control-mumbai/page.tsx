...
export default function BeesControlMumbai() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-yellow-900 via-yellow-800 to-amber-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Bee Control Services in <span className="text-orange-400">Mumbai</span></h1>
            <p className="text-xl md:text-2xl mb-8 text-yellow-100">Safe bee removal and hive relocation. Protecting both your property and bee populations.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-yellow-900 px-8 py-4 rounded-lg font-semibold text-lg transition-colors">Emergency Bee Removal</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-8 rounded-2xl">
              ...
              <p className="text-gray-600">Humane bee removal without harming the beneficial insects.</p>
            </div>
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-8 rounded-2xl">
              ...
              <p className="text-gray-600">Professional hive relocation to safe, suitable environments.</p>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-2xl">
              ...
              <p className="text-gray-600">24/7 emergency bee swarm and hive removal services.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-500 to-amber-500 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Professional Bee Removal</h2>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+918097941077" className="bg-white text-yellow-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors">📞 Call +91 80979-41077</a>
            <a href="tel:+918097941076" className="bg-yellow-700 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-yellow-800 transition-colors">📞 Call +91 80979-41076</a>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-4">Professional Bee Control Services</p>
          </div>
        </div>
      </footer>
    </div>
