          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <Link href="/" className="flex items-center space-x-2 md:space-x-3 group">
              <div className="relative">
                <div className="w-8 h-8 md:w-12 md:h-12 bg-gradient-to-br from-purple-500 via-violet-600 to-purple-700 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/20 group-hover:shadow-purple-500/30 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3">
                  <span className="text-white font-bold text-sm md:text-xl drop-shadow-sm">🐛</span>
                </div>
                <div className="absolute -inset-1 bg-gradient-to-br from-purple-400 to-violet-500 rounded-xl md:rounded-2xl blur opacity-20 group-hover:opacity-40 transition-all duration-500"></div>
              </div>
              <div className="flex flex-col">
                ...
                <span className="text-xs text-purple-600 font-medium -mt-1 opacity-70 hidden sm:block">IT Hub</span>
              </div>
            </Link>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <Link href="/" className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <div className="text-purple-400 text-sm">IT Hub</div>
                </div>
              </Link>
              <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                Professional pest control services in Rabale, Navi Mumbai. We provide eco-friendly, safe, and effective pest management solutions for IT hub offices and residential areas.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>IT Office Cockroach Control</li>
                <li>Tech-Safe Termite Treatment</li>
                <li>Office Rodent Control</li>
                <li>Tech Facility Bed Bug Treatment</li>
                <li>IT Hub Mosquito Control</li>
                <li>Complete Tech Hub Pest Control</li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Super Pest Control Rabale. All rights reserved. | Professional pest control services in Rabale, Navi Mumbai</p>
          </div>
        </div>
      </footer>
    </div>
