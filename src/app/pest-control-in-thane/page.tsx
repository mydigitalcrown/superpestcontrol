...
const faqData = [
  ...
  },
  {
    ...
    answer: "Pest control in Thane costs between ₹1,500 to ₹5,000 depending on the type of pest, property size, and treatment required. Super Pest Control offers free inspections, competitive pricing, and transparent costs with no hidden charges for Thane properties."
  },
  {
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-6">Super Pest Control Thane</h3>
              <p className="text-gray-300 mb-4">
                Professional pest control services in Thane with 10+ years of experience. 
                Safe, effective, and eco-friendly solutions for this satellite city.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© 2024 Super Pest Control Thane. All rights reserved.</p>
