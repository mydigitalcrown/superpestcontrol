...
export default function PestControlDarave() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            <Link href="/" className="flex items-center space-x-2 md:space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-orange-600 font-medium -mt-1 opacity-70 hidden sm:block">Darave</span>
              </div>
            </Link>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-gray-200 font-light">
              Expert pest management solutions for Darave&apos;s residential and commercial areas
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our Pest Control Services in Darave
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Industrial Cockroach Control", description: "Heavy-duty treatments for commercial areas", icon: "🪳", price: "₹1,800+" },
              { title: "Commercial Termite Treatment", description: "Advanced protection for business premises", icon: "🐜", price: "₹3,200+" },
              { title: "Warehouse Rodent Control", description: "Large-scale rodent management solutions", icon: "🐭", price: "₹2,500+" },
              { title: "Office Bed Bug Treatment", description: "Discreet treatment for work environments", icon: "🛏️", price: "₹2,800+" },
              { title: "Industrial Mosquito Control", description: "Comprehensive breeding site management", icon: "🦟", price: "₹1,600+" },
              { title: "Complete Commercial Pest Control", description: "Full-service business pest management", icon: "🐛", price: "₹3,500+" }
            ].map((service, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-pink-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Get Rid of Pests in Darave?
          </h2>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-2xl font-bold mb-4">Super Pest Control Darave</div>
          <p className="text-gray-400 mb-6">Professional pest control services in Darave, Mumbai</p>
