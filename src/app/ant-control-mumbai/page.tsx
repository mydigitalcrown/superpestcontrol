    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-green-900 via-green-800 to-green-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Ant Control Services in <span className="text-orange-400">Mumbai</span></h1>
            <p className="text-xl md:text-2xl mb-8 text-green-100">Complete ant elimination and colony destruction. Safe and effective ant control for all species.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-green-900 px-8 py-4 rounded-lg font-semibold text-lg transition-colors">Get Ant Treatment</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-green-500 to-green-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Stop Ant Invasions Today</h2>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-4">Professional Ant Control Services</p>
          </div>
        </div>
      </footer>
    </div>
