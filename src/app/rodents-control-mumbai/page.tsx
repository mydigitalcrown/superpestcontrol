...
const PestControlPage = ({ 
  ...
  heroColor: string;
  emoji: string;
  specialties: Array<{title: string, description: string, bgColor: string, textColor: string}>;
}) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className={`bg-gradient-to-br ${heroColor} text-white py-20`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              {title} in <span className="text-orange-400">Mumbai</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-gray-900 px-8 py-4 rounded-lg font-semibold text-lg transition-colors">
                Get Free Treatment
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {specialties.map((specialty, index) => (
              <div key={index} className={`bg-gradient-to-br ${specialty.bgColor} p-8 rounded-2xl`}>
                <div className={`w-16 h-16 ${specialty.bgColor.replace('from-', 'bg-').replace('to-', '')} rounded-2xl flex items-center justify-center mb-6`}>
      ...
      {/* Contact Section */}
      <section className={`py-20 bg-gradient-to-r ${heroColor.split(' ')[2]} ${heroColor.split(' ')[3]} text-white`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Professional {title.split(' ')[0]} Control
          </h2>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+918097941077" className="bg-white text-gray-900 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors">
              📞 Call +91 80979-41077
            </a>
            <a href="tel:+918097941076" className="bg-gray-800 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-900 transition-colors">
              📞 Call +91 80979-41076
            </a>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-4">Professional {title}</p>
          </div>
        </div>
      </footer>
    </div>
...
export default function RodentsControlMumbai() {
  return (
    <PestControlPage
      ...
      description="Complete rodent elimination and prevention. Professional mouse and rat control for homes and businesses."
      heroColor="from-gray-900 via-gray-800 to-gray-900"
      emoji="🐭"
      specialties={[
        {
          title: "Mouse Control",
          description: "Effective mouse elimination and prevention strategies.",
          bgColor: "from-gray-50 to-gray-100",
          textColor: "text-gray-600"
        },
        {
          title: "Rat Control", 
          description: "Professional rat removal and exclusion methods.",
          bgColor: "from-blue-50 to-blue-100",
          textColor: "text-blue-600"
        },
        {
          title: "Prevention",
          description: "Long-term rodent prevention and monitoring systems.",
