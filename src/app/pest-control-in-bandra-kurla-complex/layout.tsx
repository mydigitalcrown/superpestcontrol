...
export const metadata: Metadata = {
  ...
  description: 'Professional Pest Control Services in Bandra Kurla Complex (BKC), Mumbai. Expert termite control, cockroach treatment, bed bug removal for offices & commercial spaces. 100% guaranteed results. Call ☎️ +91-9136036071 for immediate service.',
